...
company: Confluent
description: |
La certification Confluent Certified Developer for Apache Kafka s'adresse aux développeurs et aux architectes de solutions. Elle couvre Confluent, Apache Kafka, Schema Registry, KSQL et Streams avec un accent sur la connaissance de la plateforme nécessaire pour développer des applications fonctionnant avec Kafka.
status: published
badgeUrl: /assets/images/badges/kafka.avif
