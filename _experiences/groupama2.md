...
- Mise en place d’une stratégie de cache Redis via Spring Gateway afin d’optimiser les performances et réduire les appels redondants
- Développement d’API REST dans une approche OpenAPI First pour le Backend For Frontend (BFF) du projet PWIE
...
- Relecture de code et collaboration avec les autres développeurs afin de garantir la qualité et la cohérence du code
- Développement de tests unitaires et tests d’intégration pour sécuriser les évolutions applicatives
- Respect des standards qualité et participation à l’amélioration continue des pratiques de développement
- Collaboration transverse avec les équipes backend, frontend et architecture dans un contexte de modernisation SI
